          ...
          <div className="tutorial-content-grid">
            ...
            <div className="tutorial-left">
              ...
              >
                ...
                <button className="px-10 py-4 bg-white text-orange-600 rounded-full text-xl font-bold hover:scale-105 transition-transform">
                  Get Started Now
                </button>
              </motion.div>
            </div>
